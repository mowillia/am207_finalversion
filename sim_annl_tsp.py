...
# Metropolis and Simulated Annealing Algorithm for Traveling Salesperson
# Aspect of the Traveling Post Graduate

### Definition of Metropolis 'Traveling Post Grad Problem"

def metropolis_tsp(n_iterations, initial_state, V, W, temp, cash):
    '''
    ...
    current_logprob = log_boltz_dist(X[0], temp)
    ...
    for i in range(n_iterations):
        ...
        proposed_logprob = log_boltz_dist(new_state, temp)
...
def sim_ann_tsp(n_cycles, initial_perm, initial_temp, temp_factor, rw_steps, V2, W2, cash2):
    '''
    ...
    while i >=0 :
        ...
        trace[i+1] = metropolis_tsp(n_iterations = rw_steps, initial_state = trace[i], V = V2, W= W2, temp = temp_vals[i], cash = cash2)
